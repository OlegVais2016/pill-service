...
import com.ps.core.model.web.login.meuhedet.LoginMeuhedetRequest;
...
@RestController
@RequestMapping("/en/users/meuhedet")
public class LoginMeuhedetController {

    @PostMapping(value = "/login")
    public HcLoginResponse login(@AuthenticationPrincipal PsUser user,
                                 @RequestBody @Valid LoginMeuhedetRequest loginMeuhedetRequest,
